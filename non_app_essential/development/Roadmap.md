...
- [ ] 1.12.4.1: Performance optimisation
- [ ] 1.12.4.2: Make file upload selection (GeoJSON, Save load, etc.) all single selection only (to reflect current functionalities and avoid bugs)
