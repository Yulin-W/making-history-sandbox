...
- [ ] 1.12.4.1: Test Suite Setup
- [ ] 1.12.4.2: Performance optimisation
- [ ] 1.12.4.3: Make file upload selection (GeoJSON, Save load, etc.) all single selection only (to reflect current functionalities and avoid bugs)
...
- [ ] 1.12.7：Change scenarios to load on request to hasten loading (i.e., by hosting them on some other site, or on same git repo or something as a subpage, can go explore options)
